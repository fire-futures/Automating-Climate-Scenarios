...
caladapt_map() 
  # uncomment the below code to add pins on the map to view where certain latitude/longitude combinations are:
  #%>%
  #addMarkers(lng = -119.712140042592, lat = 34.441631834023) %>% 
  #addMarkers(lng = -119.712466207413, lat = 34.4416245938738)
```
